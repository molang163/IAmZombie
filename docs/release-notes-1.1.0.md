...
Version 1.1.0 replaces the old COMMON configuration authority with explicit server and client authorities. Existing registry IDs, saved attachment formats, translation keys, resource paths, and the supported Minecraft/NeoForge range are unchanged.
