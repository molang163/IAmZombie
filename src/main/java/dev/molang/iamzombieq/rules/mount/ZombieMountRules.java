...
public final class ZombieMountRules {
     ...
     * here; other kinds return 0 so they keep their vanilla ridden speed. Pure logic so it stays
     ...
     * same place as chicken and big zombie while preserving the existing config override. Non-positive
    ...
    /** One spider-food row: the healing and taming progress it grants when fed to a spider. */
    ...
    // per-item numbers live in one place instead of three parallel switches. Same ids and values as before.
