...
/**
 * Giant-form balance rules split out of {@link dev.molang.iamzombieq.rules.ZombieBalanceRules}: all giant
...
public final class GiantRules {
    ...
    // ---- Giant identity: the SCALE attribute does not auto-scale reach, step height, or attack, so each of
    ...
    /** Radius in blocks of the giant's body-contact stomp aura. */
    ...
    /**
     * The crush predicate for the giant's destruction kernel. A block is crushable only when it
