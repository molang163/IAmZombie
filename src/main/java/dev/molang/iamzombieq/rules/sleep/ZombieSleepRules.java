...
public final class ZombieSleepRules {
    ...
    // fallback) and napWakeMessageKey (VOTE_PASSED_NO_SKIP), so the key exists exactly once in this file.
    ...
    /**
     * The reason {@code CoffinNapManager} is ending a nap, keeping the overlay-message choice for the whole
    ...
    /** The overlay-message translation key for the coffin vote's throttled periodic progress update. */
