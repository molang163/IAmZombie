...
/**
 * Canonical SERVER-authority schema.
 *
 * <p>The activation bootstrap validates or migrates the actual SERVER target
 * before NeoForge loads this registered specification.</p>
 */
public final class IAmZombieServerConfig {
    ...
    public static final ModConfigSpec.DoubleValue EASY_INFECTION_CHANCE = BUILDER
            ...
            .defineInRange("easyInfectionChance", ZombieInfectionRules.infectionChance(GameDifficulty.EASY), 0.0, 1.0);
    ...
    public static final ModConfigSpec.DoubleValue NORMAL_INFECTION_CHANCE = BUILDER
            ...
            .defineInRange("normalInfectionChance", ZombieInfectionRules.infectionChance(GameDifficulty.NORMAL), 0.0, 1.0);
    ...
    public static final ModConfigSpec.DoubleValue HARD_INFECTION_CHANCE = BUILDER
            ...
            .defineInRange("hardInfectionChance", ZombieInfectionRules.infectionChance(GameDifficulty.HARD), 0.0, 1.0);
