...
/**
 * Single gate for the {@code debugLogging} config (C2): {@code messageSupplier} is only evaluated, and only
 ...
 *
 * <p>C2-REV1: this is a best-effort, no-throw diagnostic boundary. A misbehaving config read, message build, or
