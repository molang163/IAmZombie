...
/**
 * FakePlayer- and connected-ServerPlayer-driven NeoForge GameTest harness for the FORM (§2.1) + ATTR (§2.2)
 * acceptance rows of {@code iamzombieq} (MC 26.2 / NeoForge 26.2.0.25-beta). Sibling to
