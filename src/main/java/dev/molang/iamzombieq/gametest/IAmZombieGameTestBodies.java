...
final class IAmZombieGameTestBodies {
     ...
     * the window it must stay DENIED (RC4: the grace-suppressed sweep created no player-grudge), and a DELIBERATE
    ...
    static void infectionVillagerSweepGrace(GameTestHelper helper) {
        ...
        helper.startSequence()
                ...
                // POST-WINDOW (+28 -> ~T0+30, past the 10t window): RC4 boundary -- no grudge was created, so re-posting
    ...
    /**
     * T-infection-piglin-sweep-grace (RC4-sweep / Option B, NeutralMob path): like the villager case but the kin is a
