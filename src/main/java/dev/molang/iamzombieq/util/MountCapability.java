...
public enum MountCapability {
    ...
    /**
     * A9 ownership helper: true iff {@code entity} is a {@link Spider} whose {@code SPIDER_MOUNT} attachment is
    ...
    /**
     * A9 ownership helper for an already-narrowed {@link Spider}: true iff its {@code SPIDER_MOUNT} attachment is
