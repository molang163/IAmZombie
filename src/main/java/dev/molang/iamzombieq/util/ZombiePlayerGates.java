...
/**
 * Single definition of the mod's "is this player subject to the zombie-player rules?" gate (A8).
 *
 * <p>Historically every gameplay class carried its own {@code private static boolean isZombiePlayer(Player p)}
 * (or an inline {@code !p.isSpectator()}), all agreeing that — per N6 — a creative player is still a zombie and
...
public final class ZombiePlayerGates {
    ...
    /**
     * True iff {@code player} is subject to the zombie-player rules: a non-spectator (creative included, per N6).
