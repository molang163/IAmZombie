...
public final class ZombiePlayerEvents {
    ...
    public static void onLivingDeath(LivingDeathEvent event) {
        ...
        // C2: logs result.nextState() (not nextData.state()) so the lambda never captures the reassigned `nextData`.
    ...
    private static PlayerZombieData grantFirstEvolutionReward(
        ...
        // A6: the "which outcome grants which reward (and only once)" decision is a pure rule; the item side effects
