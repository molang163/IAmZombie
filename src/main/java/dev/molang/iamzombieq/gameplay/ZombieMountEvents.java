...
public final class ZombieMountEvents {
    ...
    public static void onIncomingDamage(LivingIncomingDamageEvent event) {
        ...
        if (healthAfterDamage <= 0.0F) {
            // A2: the snapshot map (PENDING_HORSE_HEALTH_RATIOS) and the whole horse/nautilus death-conversion
    ...
    public static void onMobDespawn(MobDespawnEvent event) {
        // B4 defensive backstop, moved from MobMixin#removeWhenFarAway (DEC-6): an actively-serving mod mount
