...
public final class ZombieMobTargetingAdapter {
    ...
    /**
     * Two Drowned must not start fighting each other from a Drowned's trident friendly fire. Returns true
    ...
    /**
     * Should this nearby Drowned be recruited to attack the offending Drowned? True when the candidate is a
